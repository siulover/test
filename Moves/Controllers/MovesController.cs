...
namespace Moves.Controllers
{
    ...
    {
        private MovesContext db = new MovesContext();
        ...
        public ActionResult Filters(string title)
        {
            if (!String.IsNullOrEmpty(title))
            {
                var moves = (from m in db.Moves where m.Title.Contains(title) select m).ToList<Move>();
